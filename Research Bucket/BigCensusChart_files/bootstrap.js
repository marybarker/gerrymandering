...
+function ($) {
  ...
  // bstooltip PUBLIC CLASS DEFINITION
  // ===============================
  ...
  bstooltip.DEFAULTS = {
    ...
    placement: 'top',
    selector: false,
    template: '<div class="bstooltip" role="bstooltip"><div class="bstooltip-arrow"></div><div class="bstooltip-inner"></div></div>',
    trigger: 'hover focus',
    title: '',
    delay: 0,
    html: false,
  ...
  bstooltip.prototype.getCalculatedOffset = function (placement, pos, actualWidth, actualHeight) {
  ...
  bstooltip.prototype.getViewportAdjustedDelta = function (placement, pos, actualWidth, actualHeight) {
  ...
  function Plugin(option) {
    return this.each(function () {
      ...
      if (!data) $this.data('bs.bstooltip', (data = new bstooltip(this, options)))
      if (typeof option == 'string') data[option]()
    })
  }
...
+function ($) {
  ...
  if (!$.fn.bstooltip) throw new Error('Popover requires bstooltip.js')

  Popover.VERSION  = '3.3.4'

  Popover.DEFAULTS = $.extend({}, $.fn.bstooltip.Constructor.DEFAULTS, {
    placement: 'right',
    trigger: 'click',
    content: '',
    template: '<div class="popover" role="bstooltip"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>'
  })


  // NOTE: POPOVER EXTENDS bstooltip.js
  // ================================

  Popover.prototype = $.extend({}, $.fn.bstooltip.Constructor.prototype)
